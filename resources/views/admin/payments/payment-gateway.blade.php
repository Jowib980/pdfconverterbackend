    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <!-- ✅ START form -->
            <form method="POST" action="{{ route('bulk-delete-gateway') }}">
              @csrf
              @method('DELETE')
                ...
                <div class="card-body">
                  <div class="row mb-2">
                    ...
                    <div class="col-md-6 text-right">
                      <p>Total Gateways: {{ $gateways->total() }}</p>.
                    </div>
                  </div>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form method="POST" action="{{ route('delete-gateway', $gateway->id)}}" style="display: inline-block;">
                              @csrf
                              @method('DELETE')
                              <button class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this gateway record?')"><i class="fas fa-trash"></i>  </button>
                            </form>
                          </td>
                        </tr>
                      @empty
